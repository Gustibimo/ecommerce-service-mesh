...
public class OrderItemResource {
    ...
    public ResponseEntity<List<OrderItem>> getAllOrderItems(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
