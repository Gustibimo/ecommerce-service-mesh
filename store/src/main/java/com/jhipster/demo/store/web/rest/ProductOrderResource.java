...
public class ProductOrderResource {
    ...
    public ResponseEntity<List<ProductOrder>> getAllProductOrders(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
