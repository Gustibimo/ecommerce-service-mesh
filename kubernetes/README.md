...
```
$ docker image tag invoice gstbimo/invoice
$ docker push gstbimo/invoice
$ docker image tag notification gstbimo/notification
$ docker push gstbimo/notification
$ docker image tag store gstbimo/store
$ docker push gstbimo/store
```
